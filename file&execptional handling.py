...
f = open("demo1.txt") # if you load a file in a different path then you will get an error

os.chdir(r'C:\Users\Bharani Kumar\Desktop\Data Analytics\Python_Module') # Change the current working directory to 'D:\\Data'

f = open("demo1.txt") # this file is in path provided in line #13. So you wont get any error.
...
f.write("Erase and add new lines")

# Close the file
f.close()

# Open demo1.txt file on computer and add a few lines. 

# Open the file "demo1.txt" again
f = open("demo1.txt")

f.readline()   # one line at a time  --> first line
...
f = open('C:/Users/Bharani Kumar/Desktop/Data Analytics/EDA_Module/education.csv', 'r')
...
print ("Come out of try, except, else, and finally blocks.")
